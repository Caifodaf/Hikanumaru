...
class LoginFragment : BaseFragment() {
    ...
    private fun FragmentLoginBinding.initBtnNav() {
        TVBtnResetPassword.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_navigation_login_to_navigation_reset_password_stage_one, null)
        }
        ...
        TVBtnLogin.setOnClickListener {
            ...
            when(isValidLogin() && isValidPassword()){
                true->{
                    ...
                    //Log.e("saveHomeCacheVM", "сщву - " + NetworkUtils.isInternetAvailable(requireContext()))
                }
                false->{
                    if (isValidLogin()) {
